        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card className="p-8" data-aos="fade-up">
            <div className="prose prose-gray max-w-none text-gray-300">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Interpretation</h3>
              <p className="mb-6">
                The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
              </p>
              <h3 className="text-xl font-bold text-white mb-2">Definitions</h3>
              <p className="mb-6">
              ...
              <ul className="list-disc pl-5 mb-6">
                ...
                <li>
                  <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TheTechInspo (PVT) Ltd, No. 102 Gregory’s Road, Colombo 00700, Sri Lanka.
                </li>
                <li>
                ...
                <li>
                  <strong>Website</strong> refers to TheTechInspo , accessible from https://thetechinspo.com/
                </li>
                <li>
              ...
              <h3 className="text-xl font-bold text-white mb-2">Severability</h3>
              <p className="mb-6">
                If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
              </p>
              <h3 className="text-xl font-bold text-white mb-2">Waiver</h3>
              <p className="mb-6">
              ...
              <ul className="list-disc pl-5 mb-6">
                <li>
                  By email: info@thetechinspo.com
                </li>
                <li>
                  By visiting this page on our website: <a href="https://thetechinspo.com/" className="text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">https://thetechinspo.com/</a>
                </li>
                <li>
                  By phone number: +94765429831
                </li>
              </ul>
